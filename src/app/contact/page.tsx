  ...
  return (
    <div className="container-custom py-16 animate-fade-in">
      <div className="max-w-xl mx-auto text-center mb-16">
        <h1 className="text-4xl font-bold text-surface-900 tracking-tight mb-4">Get in Touch</h1>
        <p className="text-lg text-surface-600">
          Have questions about the marketplace, an order, or your seller account? We're here to help.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="glass rounded-3xl p-8 space-y-8">
            <h3 className="text-xl font-bold text-surface-900">Contact Information</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium text-surface-900">Phone</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium text-surface-900">Headquarters</p>
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <Input label="First Name" placeholder="Jane" required disabled={loading} />
                  <Input label="Last Name" placeholder="Doe" required disabled={loading} />
                </div>
                
                <Input type="email" label="Email Address" placeholder="jane@example.com" required disabled={loading} />
