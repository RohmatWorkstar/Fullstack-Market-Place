  ...
  return (
    <div className="container-custom max-w-4xl py-16 animate-fade-in">
      <div className="mb-12 border-b border-surface-200 pb-8">
        <h1 className="text-4xl md:text-5xl font-bold text-surface-900 tracking-tight"><Translate section="terms" textKey="title" /></h1>
        <p className="text-surface-500 mt-4 text-lg"><Translate section="terms" textKey="lastUpdated" /></p>
      </div>
      ...
      <div className="space-y-12 text-surface-600 leading-relaxed text-lg">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="terms" textKey="accounts" /></h3>
          </div>
          <div className="pl-12">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="terms" textKey="sellerResp" /></h3>
          </div>
          <div className="pl-12">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="terms" textKey="prohibited" /></h3>
          </div>
          <div className="pl-12">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="terms" textKey="payment" /></h3>
          </div>
          <div className="pl-12">
        ...
        <section className="bg-surface-50 p-8 rounded-3xl border border-surface-200 mt-16">
          <h3 className="text-2xl font-bold text-surface-900 mb-3"><Translate section="terms" textKey="questions" /></h3>
