  ...
  return (
    <div className="container-custom max-w-4xl py-16 animate-fade-in">
      <div className="mb-12 border-b border-surface-200 pb-8">
        <h1 className="text-4xl md:text-5xl font-bold text-surface-900 tracking-tight"><Translate section="privacy" textKey="title" /></h1>
        <p className="text-surface-500 mt-4 text-lg"><Translate section="privacy" textKey="lastUpdated" /></p>
      </div>
      ...
      <div className="space-y-12 text-surface-600 leading-relaxed text-lg">
        ...
        <section className="space-y-4">
           <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="privacy" textKey="collect" /></h3>
           <p><Translate section="privacy" textKey="collectDesc" /></p>
        </section>

        <section className="space-y-4">
           <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="privacy" textKey="use" /></h3>
           <p><Translate section="privacy" textKey="useDesc" /></p>
        </section>

        <section className="space-y-4">
           <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="privacy" textKey="share" /></h3>
           <p><Translate section="privacy" textKey="shareDesc" /></p>
        </section>

        <section className="space-y-4">
            <h3 className="text-2xl font-bold text-surface-900 tracking-tight"><Translate section="privacy" textKey="security" /></h3>
        ...
        <section className="bg-primary-50 p-8 rounded-3xl border border-primary-100 mt-16">
          <h3 className="text-2xl font-bold text-primary-900 mb-3"><Translate section="privacy" textKey="contact" /></h3>
